...
[ SerializeField , Tooltip ( "Vector offset of camera from spline follower" )] Vector3
cameraOffset = Vector3 .zero;
[ SerializeField , Range (1, 50), Tooltip ( "Forward speed along spline" )] float thrust = 5;
[ SerializeField , Range (1, 50), Tooltip ( "Forward speed boost along spline" )] float
thrustBoost = 8;
[ SerializeField , Range (1, 50), Tooltip ( "Speed (up/down/left/right) of ship" )] float speed =
20;
...
[ SerializeField , Range (0, 1), Tooltip ( "Normalized distance from edge of screen to clamp ship" )] float edgeClamp = 0.2f;
bool boost;
Vector2 inputMove;
